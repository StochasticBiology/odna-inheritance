...
#define NGEN 1000        // number of generations in simulation
#define NDNA 100         // number of DNAs per cell
#define NSAMP 500        // number of samples to run
...
double fitness(Ind I, int env, int t)
{
  switch(env)
    {
    case 0: return (I.a+I.b);
    case 1: return (I.a+0.5*I.b);
    case 2: return (I.b+0.5*I.a);
    case 3: return (t % 2 == 0 ? I.b+0.5*I.a : I.a+0.5*I.b);
    case 4: return (t/5 % 2 == 0 ? I.b+0.5*I.a : I.a+0.5*I.b);
    default: return -1;
    }
}
		  ...
		  for(expt = 0; expt < NSAMP; expt++)
		      ...
		      for(t = 0; t < NGEN; t++)
			{
			  ...
			  for(i = 0; i < NPOP; i++)
				...
				{
				  fprintf(fp, "%i,%f,%i,%f,%i,%i,%i,%i,%i,%i,%f\n", env, MU, DUI, LEAKAGE, expt, t, i, I[i].a, I[i].b, I[i].c, f[i]);
				}
			    }
